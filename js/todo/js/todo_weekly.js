...
window.renderTodoWeeklyContent = function() {
    ...
    window.omniTodoState.characters.forEach(char => {
        ...
        html += `
            <div class="omni-char-card" style="width: 340px; box-sizing: border-box;">
                ...
                <div class="hw-scroll-list">
                    <!-- 하이마운틴, 앵글러 컴퍼니, 악몽선경 클리어 플래그 동기화 행 주입 -->
                    ...
                    ${window.renderHwItem(char.id, 'weekly_nightmare', '에픽 던전 : 악몽선경', data.weekly_nightmare, '완료', '대기')}
                </div>
            </div>
        `;
    });
