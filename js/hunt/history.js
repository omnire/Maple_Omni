...
window.openHistoryDetailModal = function(dateStr) {
    ...
    if (headerTitle) {
        const totalMinutes = targetRecords.length * 30;
        const timeLabel = totalMinutes >= 60 
            ? `${Math.floor(totalMinutes / 60)}시간 ${totalMinutes % 60}분` 
            : `${totalMinutes}분`;
        headerTitle.innerHTML = `📋 <b>${dateStr.replace(/-/g, '.')}</b> <span style="font-size:11px; color:var(--accent-purple, #a78bfa); margin-left:5px; font-weight:700;">⏱️ 총 ${timeLabel}</span>`;
    }
    ...
    if (targetRecords.length === 0) {
        sessionsHtml = `<div style="text-align:center; padding:20px; font-size:11.5px; color:var(--text-muted); font-weight:700;">확정 저장된 사냥 기록 내역이 없습니다.</div>`;
    } else {
            ...
            <div class="v14-history-main-flex-wrapper">
                ...
                <div class="v14-month-summary-vertical-sidebar">
                    ...
                    <div class="v14-sidebar-stats-card">
                        ...
                        <span class="v14-sidebar-stats-value" id="v14SideMonthTotalMeso" style="color:var(--accent-purple, #a78bfa);">0 Meso</span>
                    ...
                    <div class="v14-sidebar-stats-card">
                        ...
                        <span class="v14-sidebar-stats-value" id="v14SideMonthTotalLoot" style="color:var(--text-main);">💎 0개 / ✨ 0개</span>
                    ...
                    <div class="v14-sidebar-stats-card">
                        ...
                        <span class="v14-sidebar-stats-value" id="v14SideMonthTotalCount" style="color:var(--text-muted);">총 0회차 가동</span>
